...
public:
	...
	// In paper <<An As-Short-As-Possible Introduction to the Least Squares, Weighted Least
	// Squaresand Moving Least Squares Methods for Scattered Data Approximationand Interpolation>>
	// m represents total degree
	int m = 3;
};
